...
def build_control_file():
    ...
    pst = pyemu.Pst.from_io_files(tpl_files,in_files,ins_file,out_file)
    ...
    obs.sort_values(["obgnme","obsnme"],inplace=True)
    ...
    pi_eqs,pi_weights,pi_names,pi_groups = [obj_eq],[1.0],["obj_func"],['obj_func']
    #sp0
